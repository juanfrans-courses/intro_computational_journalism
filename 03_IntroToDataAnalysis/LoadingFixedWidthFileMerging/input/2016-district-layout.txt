README.TXT file for the 2016 SAIPE School District Estimates FTP Directory
...
I.    File Organization:
    ...
    identified in the 2015 school district mapping survey,
    which asked about all school districts as of January 1, 2016 and 
    used school district boundaries for the 2015-2016 school year.

    The 2016 estimates are consistent with the population controls and 
    income concepts used in the 2016 American Community Survey single-year 
    estimates.    
...
II.   File Names
     ...
     There are two kinds of files here:
        ...
        1) USSD16.txt           (A large file containing the estimates for
                                 every school district in the nation)

        2) sd16_[STATE].txt     (Smaller files containing estimates for 
